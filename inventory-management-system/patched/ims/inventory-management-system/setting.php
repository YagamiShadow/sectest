	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<form action="php_action/changeBio.php" method="post" class="form-horizontal" id="changeBioForm">
					<fieldset>
						<legend>Change Bio</legend>

						<div class="changeBioMessages"></div>			
					  ...
					  <div class="form-group">
					    <div class="col-sm-offset-2 col-sm-10">
							<input type="hidden" name="user_id" id="user_id" value="<?php echo $result['user_id'] ?>" /> 
					      	<button type="submit" class="btn btn-success" data-loading-text="Loading..." id="changeBioBtn"> <i class="glyphicon glyphicon-ok-sign"></i> Save Changes </button>
					    </div>
					  </div>
					</fieldset>
				</form>
