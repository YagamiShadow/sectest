...
public class XssOrdersPhp46Min extends BaseTest {
    private Integer orderId;

    /*
    Attack description:
    - create order with quotes attribute escape xss payload as "grandTotalValue"
    ...
    public void test() {
        ...
        assertPayloadNextTo(payload, "grandTotal");
    }
