...
public class XssOrdersPhp42Min extends BaseTest {
    private Integer orderId;

    /*
    Attack description:
    - create order with quotes attribute escape xss payload as "subTotalValue" (eg: " /><h1>Ciao</h1><input x=")
    ...
    public void test() {
        ...
        assertPayloadNextTo(payload, "subTotalValue");
    }
